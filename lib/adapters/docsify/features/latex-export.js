...
// Format definitions — each format carries its own renderers as first-class functions.
// To add a new format: add an entry here. Pipeline reads these, no internal maps needed.
