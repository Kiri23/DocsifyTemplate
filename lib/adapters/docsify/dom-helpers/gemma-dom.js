...
const CSS = `
  ...
  /* Model dropdown */
  #gemma-model-dropdown { position: absolute; top: calc(100% + 4px); left: 0; min-width: 240px; background: var(--surface-page, #faf9f7); border: 1px solid var(--border-subtle, #e7e5e4); border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.1); z-index: 10; overflow: hidden; animation: gemma-slide-down 0.15s ease-out; }
  ...
  <div id="gemma-panel" class="gemma-hidden">
    <div id="gemma-header">
      <div id="gemma-title">
        ...
        <div id="gemma-model-dropdown" class="gemma-hidden"></div>
      </div>
