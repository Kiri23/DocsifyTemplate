...
export { createChatEngine, getModelCatalog, buildSystemPrompt } from '../../packages/chat/core/chat-engine.js';

// Legacy compat: SYSTEM_PROMPT as a static string (uses default tool config)
import { buildSystemPrompt } from '../../packages/chat/core/chat-engine.js';
export const SYSTEM_PROMPT = buildSystemPrompt();

// Legacy compat: MODEL_CATALOG as a static array (uses default model config)
import { getModelCatalog } from '../../packages/chat/core/chat-engine.js';
