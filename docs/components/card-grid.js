// Card Grid Component — warm surface cards for navigation
...
window.CardGrid = function CardGrid(cards) {
  ...
  return '<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-2">' +
    cards.map(function(card) {
      ...
      return '<a href="' + href + '" class="block bg-surface rounded-xl p-5 md:p-6 min-h-[120px] border border-border hover:border-primary/40 hover:shadow-[0_2px_12px_rgba(8,145,178,0.08)] transition-all duration-200 group no-underline">' +
